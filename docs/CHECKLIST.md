...
| D3 | Camera permission dialog / live-feed-vs-paper-mode outcome on S25 + S22: **not yet explicitly confirmed** | The device protocol's steps 3–5 remain open; D1/D2 came from real dwelling, which outranks protocol order |
