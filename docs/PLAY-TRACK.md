...
| Privacy policy | ✅ **`https://audhdities.com/apps/privacy`** — the one page for every app, KP's ruling 2026-09-01: *"for all apps it will be a single page we can maintain"* (his word the same evening: *"also we now have this https://audhdities.com/apps/privacy"*; the conductor read it HTTP 200 that night; source `AudHDities/docs/privacy-apps/privacy-apps.md`). The in-repo `PRIVACY.md` stands; it is no longer what the Console is pointed at. **was:** `PRIVACY.md` in-repo → `https://github.com/Quantum-Weaver/resonance-lantern/blob/main/PRIVACY.md` — repo **verified public 2026-08-24** (HTTP 200 unauthenticated) |
...
| 2026-09-01 (later) | **The Console's truth, from KP's paste: Closed testing, Aug 24, 2026.** KP pasted the Play Console's app list this day; its line for Resonance Lantern (`com.audhd.resonance_lantern`) reads **Closed testing** with the Console's own date **Aug 24, 2026** — the day the ruled key was cut and the AAB signed. The first ascent was already done that day, at his hand. A lamp cannot see the Console: the row above's "nothing is uploaded", and the 08-24 rows' "upload at his hand after", were read from the shelf and this file, not from the Console — the shelf's silence, not the Console's word. Which release reached the track is not in the paste: v0.2.1 (versionCode 2001) is the signed bundle on the shelf, but the paste names no version, so the version on the track is unconfirmed by the paste. The Console's count column reads 2 for Lantern; what it counts is not read here. *Provenance: KP's paste, 2026-09-01.* |
| 2026-09-01 (later still) | **The privacy policy URL for the Console is now the single page** — `https://audhdities.com/apps/privacy`, at KP's word this day: "also we now have this https://audhdities.com/apps/privacy" and "for all apps it will be a single page we can maintain". The Standards-check row above now names it, the former per-repo GitHub URL kept beside it as *was*. The listing's Privacy policy URL field in the Console is his hands to change; a lamp cannot see whether the Console already carries it. *Provenance: KP's word, 2026-09-01.* |
