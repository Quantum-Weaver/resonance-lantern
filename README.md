...
- **Projector** — the current reference or practice outline full-screen on
  ...
  the app, built 2026-07-12 (the retired checklist's Phase 8 — git history before 2026-08-25; the realm's open items and plans live in the base — `python ../resonance-progenatrix/progenatrix.py recall --realm resonance-lantern`).
